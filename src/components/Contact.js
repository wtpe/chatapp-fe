...
const Contact = () => {
  ...
  return (
    <Box sx={{ width: '320px', height: '100vh' }}>
      <Stack sx={{ height: '100%' }}>
        <Box sx={{ boxShadow: '0px 0px 2px rgba(0,0,0.25)', width: '100%', backgroundColor: theme.palette.mode === 'light' ? '#F8FAFF' : theme.palette.background }}>
          <Stack sx={{ height: '100%', p: 2 }} direction='row' alignItems='center' justifyContent='space-between' spacing={3} >
            <Typography variant=''>Contact Info</Typography>
            <IconButton onClick={() => {
        ...
        <Stack sx={{ height: '100%', position: 'relative', flexGrow: 1, overflowY: 'scroll' }} p={3} spacing={2} >
          ...
          <Stack spacing={0.5} >
            ...
            <Typography variant='body2'>Hello, myfriend</Typography>
          </Stack>
          ...
          <Stack direction='row' spacing={2} alignItems='center' >
            ...
            <Stack spacing={0.5}>
              <Typography variant='subtitle2'>Thanh Ngo</Typography>
              <Typography variant='subtitle2'>Owl, Rabbit, You</Typography>
            </Stack>
          </Stack>
